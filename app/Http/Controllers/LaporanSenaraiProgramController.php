...
class LaporanSenaraiProgramController extends Controller
{
    ...
    public function excel($program_id,$agensi_id){
        ...
        return Excel::download(new LaporanSenaraiProgramExport($laporan_data), 'program_bantuan.xlsx');
        // return (new LaporanSenaraiProgramExport($program_id))->download('profil_data.pdf', \Maatwebsite\Excel\Excel::DOMPDF);
    ...
    public function viewpdf($program_id,$agensi_id){
        ...
        return view('laporan-senarai-program.viewpdf',['laporan' => $laporan]);
    }
    ...
    public function exportPdf($program_id,$agensi_id){
        ...
        $pdf = PDF::loadView('laporan-senarai-program.viewpdf',['laporan' => $laporan_data]);
...
class LaporanSenaraiProgramExport implements  WithHeadings,FromArray
{
    protected $data;
