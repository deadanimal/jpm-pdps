...
@section('content')
    @component('layouts.headers.auth') 
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('laporan-program-bantuan.index') }}" class="">{{ __('Laporan Program Bantuan') }}</a></li>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="get" class="item-form" action="{{ route('laporan-program-bantuan.index') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col">
