            ...
            <section class="bg-grey">
              <div class="container pt-0">
                <div class="section-content">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-12 text-center pt-20"> <p style="font-size:1.4em;color:black;"><b>Insuran Sosial</b></p></div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12 pt-20">
                        <p style="font-size:1.3em;color:black;">
                          1. Mengkaji dan merangka dasar, strategi, dan pelan tindakan bagi Insuran Sosial (SI).<br />
                          2. Menyelaras pelaksanaan program-program dan aktiviti dalam pelan tindakan SI oleh Kementerian/Jabatan/Agensi yang terlibat.<br />
                          3.Menyediakan laporan prestasi pelaksanaan berdasarkan program dan aktiviti dalam pelan tindakan SI berdasarkan input daripada Kementerian/Jabatan/Agensi yang terlibat.<br />
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12 pt-20">
                        <p style="font-size:1.3em;color:black;">
                          1. Mengkaji dan mengenal pasti jurang dalam cabang keselamatan sosial bagi kumpulan sasaran.<br />
                          2.Menambah baik skim KWSP bagi menangani ketidakcukupan simpanan persaraan.<br />
                          3.Menambah baik skim PERKESO untuk menjadikannya lebih mampan.<br />
                          4.Memperluaskan perlindungan KWSP dan PERKESO kepada semua rakyat Malaysia.<br />
                          5.Menjadikan insurans sosial sebagai salah satu skim perlindungan selain kemudahan sedia ada bagi skim pencen sektor awam.<br />
                          6.Mengukuhkan perlindungan sosial untuk kesihatan.<br />
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12 pt-20">
                        ...
                        <p style="font-size:1.3em;color:black;">
                          <b>Sekreteriat</b> : Pejabat Belanjawan Negara, MOF
                        </p>
                        <p style="font-size:1.3em;color:black;">
                          <span class="row">
                            <span class="col-md-3">1. JPA</span>
                            <span class="col-md-3">2. MEA</span>
                            <span class="col-md-3">3. KPWKM</span>
                            <span class="col-md-3">4. KSM</span>
                          </span>
                          <span class="row">
                            <span class="col-md-3">5. KKM</span>
                            <span class="col-md-3">6. KWSP</span>
                            <span class="col-md-3">7. PERKESO</span>
                            <span class="col-md-3">8. KWAP</span>
                          </span>
                          <span class="row">
                            <span class="col-md-3">9. LTAT</span>
                            <span class="col-md-3">10. ICU JPM</span>
                            <span class="col-md-3">11. BNM</span>
                            <span class="col-md-3">12. SWRC</span>
                          </span>
                          <span class="row">
                            <span class="col-md-6">13. PPA (Private Pension Administrator)</span>
