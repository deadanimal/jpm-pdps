                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        ...
                        ?>
                          ...
                          <div class="row">
                            <div class="col-md-12 pt-10 pb-10 text-white" style="background-color:#001d87;font-size:1.3em;border: 1px solid black;">
                              <span class="row pl-0">
                                <span class="col-md-10 text-left">{{ucwords($program_data->nama)}}</span>
                                <span class="col-md-2 text-right"><i class="fa fa-bars"></i>
                                </span>
                              </span>
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Objektif</b></p>
                              {{ucwords($program_data->objektif)}}
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Syarat Program</b></p>
                              {{ucwords($program_data->syarat_program)}}
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Agensi</b></p>
                              {{ucwords($program_data->agensi_nama)}}
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Manfaat</b></p>
                              {{ucwords($program_data->manfaat_nama)}}
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Nilai (RM)</b></p>
                              {{ucwords($program_data->kos)}}
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Kekerapan</b></p>
                              {{ucwords($program_data->kekerapan_nama)}}
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Kategori</b></p>
                              {{ucwords($program_data->kategori_nama)}}
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Sub Kategori</b></p>
                              <?php foreach($sub_kategori_data as $skd_val){ ?>
                                {{ucwords($skd_val['nama'])}}
                                <ul style="padding-left:20px;padding-top:10px">
                                  <?php foreach($prog_master as $pm_val){ 
                                    if($pm_val->sub_kat_id == $skd_val['id']){
                                  ?>
                                    <li style="list-style-type: square;">{{$pm_val->jenis_sub_cat_name}}</li>
                                  <?php }} ?>
                                </ul>
                              <?php } ?>
                            </div>
                            <div class="col-md-12 pt-10 pb-10 text-black" style="background-color:#f5f5f5;font-size:1.1em;border: 1px solid black;">
                              <p><b>Maklumat & keterangan lanjut</b></p>
                              <a href="//{{$program_data->url}}/" target="_blank"><u>{{$program_data->url}}</u></a>
                            </div>
                          </div>
