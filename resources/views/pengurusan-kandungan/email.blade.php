...
<div class="container">
                ...
                <table>
                        <?php if($media != '-'){ ?>
                                <tr>
                                        ...
                                        <td style="width: 30%"><b>Jenis</b></td>
                                        <td style="width: 40%"><b>: {{ ($media=='2'?'Banner':'Berita') }}</b></td>
                                        <td style="width: 15%"></td>
                                </tr>
                        <?php } ?>
                        <?php if($agensi != '-'){ ?>
        ...
        <?php }else{ ?>
                ...
                <br /><br /><br />
                Pemohonan <b>{{ ($media == '1'?'Berita':'Banner') }}</b> bagi <b>{{ ($media == '1'? ucwords($tajuk):ucwords($program)) }}</b> yang telah dipohon pada {{ date('d-m-Y', strtotime($tarikh_pohon)) }} telah <?php if($status=='2'){ echo 'diluluskan'; }else if($status=='3'){ echo 'ditolak'; } ?>
