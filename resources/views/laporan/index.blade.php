...
@section('content')
    @component('layouts.headers.auth') 
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('laporan.index') }}" class="">{{ __('Laporan') }}</a></li>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="get" class="item-form" action="{{ route('laporan.index') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-2"><label class="form-control-label">Laporan</label></div>
                                    <div class="col-md-8">
